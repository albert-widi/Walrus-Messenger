...
/**
 * Created by Albert Widiatmoko on 29/12/13.
 */
public class TesterAdapter extends ArrayAdapter {
    private Context context;
    ArrayList<Message> message;

    public TesterAdapter(Context context, ArrayList<Message> messageData) {
        super(context, R.layout.fragment_tester, messageData);
